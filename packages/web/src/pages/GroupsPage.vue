  ...
  <div class="min-h-screen bg-gray-50">
    ...
    <header class="bg-white shadow-sm sticky top-0 z-10">
      <div class="container mx-auto px-4 py-4 flex items-center gap-4">
        ...
        <h1 class="text-lg font-bold">グループチャット</h1>
      </div>
    </header>
    ...
    <main class="container mx-auto px-4 py-6">
      ...
      <div v-else-if="groups.length === 0" class="text-center py-12">
        ...
        <p class="text-gray-500 mb-2">参加中のグループはありません</p>
        <p class="text-sm text-gray-400">募集に参加するとグループが作成されます</p>
      </div>
          ...
          <div class="flex items-start gap-4">
            ...
            <div class="flex-1 min-w-0">
              <div class="flex items-center justify-between mb-1">
                ...
                <span v-if="group.lastMessage" class="text-xs text-gray-400 flex-shrink-0 ml-2">
              ...
              <p v-if="group.lastMessage" class="text-sm text-gray-600 truncate">
                <span class="text-gray-400">{{ group.lastMessage.senderNickname }}:</span>
