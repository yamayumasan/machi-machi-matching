    ...
    <div class="w-full max-w-lg">
      ...
      <div class="mb-8">
        <div class="flex justify-between items-center mb-2">
          <span class="text-sm text-primary-500">Step {{ currentStep }}/{{ totalSteps }}</span>
      ...
      <div class="bg-white rounded-xl border border-primary-200 p-8">
        ...
        <div v-if="currentStep === 1" class="space-y-6">
          <div class="text-center mb-6">
            ...
            <p class="text-sm text-primary-500 mt-2">アイコンを設定（任意）</p>
          </div>

          <div>
            <label for="nickname" class="block text-sm font-medium text-primary-700 mb-1">
        ...
        <div v-if="currentStep === 2">
          <p class="text-primary-600 mb-4">興味のあるものを選んでください（複数選択可）</p>
        ...
        <div v-if="currentStep === 3">
          <p class="text-primary-600 mb-4">主に活動するエリアを選んでください</p>
          <div class="space-y-3">
            <button
        ...
        <div v-if="currentStep === 4">
          <p class="text-primary-600 mb-4">よく活動する場所を設定しましょう（任意）</p>
          <p class="text-sm text-primary-500 mb-6">近くの募集を見つけやすくなります</p>
          <LocationPicker
            ...
            label=""
          />
          <p class="text-xs text-primary-400 mt-4 text-center">
